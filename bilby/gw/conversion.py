...
def f(mass_ratio=1, a_1=0.1, a_2=0.1):
    return np.arccos((a_1 - mass_ratio*a_2) / (a_1 + mass_ratio*a_2))

def conv(converted_parameter):
    q = converted_parameter['mass_ratio']
    chi1 = converted_parameter['a_1']
    chi2 = converted_parameter['a_2']
    converted_parameter['tilt_1'] = f(q, chi1, chi2)
    converted_parameter['tilt_2'] = f(q, chi1, chi2)
...
def convert_to_lal_binary_black_hole_parameters(parameters):
    ...
    if "tilt_1" not in converted_parameters or "tilt_2" not in converted_parameters:
        converted_parameters = conv(converted_parameters)
